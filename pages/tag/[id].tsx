    ...
    <>
      ...
      <div className='flex flex-wrap max-w-screen-xl mx-auto'>
        <main className='w-full p-2 lg:w-2/3'>
          <h2 className="px-2 mt-2 mb-5 text-2xl font-medium">タグ「{tagdata[0].tag}」記事一覧</h2>
            ...
            <Link key={index} href={`/${ar.id}`} data-id={ar.id}>
              <a>
                <article className='flex mb-3 transition-all bg-white rounded-xl shadow-card text-nicoblack hover:text-themepurple hover:bg-themepurple_bg'>
                  <img className="object-cover w-1/5 shrink-0 aspect-video rounded-l-xl" src={ar.thumbnail ? ar.thumbnail.url + '?fm=webp&w960&h540' : '/ogp.png'} width='960' height="540" alt={ar.title} />
                  <div className="p-3">
