...
const Header = () => {
  ...
  return (
    <header className={`${styles.header} flex flex-col text-theme_light-text-current justify-between mx-auto py-4 px-8 md:flex-row md:items-center fixed top-4 left-4 font-medium`}>
      <div className='flex flex-row justify-between'>
        ...
        <button className='relative flex items-center justify-center text-2xl w-[25px] aspect-square md:hidden' onClick={toggleSPMenu}>
